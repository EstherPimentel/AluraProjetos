...
//letrasMaius($contasCorrentes['conta1']); // letra maiúscula não quer funcionar

foreach ($contasCorrentes as $i => $conta) {
    exibeMensagem("$i {$conta['titular']} {$conta['saldo']}"); // forma utilizada
}

// outra forma utilizada com FUNÇÃO LIST
foreach ($contasCorrentes as $i => $conta) {
